...
namespace JellySona
{
    ...
    {
        private const string MenuName = "JellySona";
        ...
        public static class Modes
        {
            ...
            {
                private static readonly CheckBox _UseQinCombo;
                private static readonly CheckBox _useRinCombo;

                public static bool UseQinCombo
                {
                    get { return _useQinCombo.CurrentValue; }
                }
                public static bool UseRinCombo
                {
                    get { return _useRinCombo.CurrentValue; }
                }

                static Combo()
                {
                    Menu.AddGroupLabel("Combo");
                    _useQ = Menu.Add("UseQinCombo", new CheckBox("UseQinCombo"));
                    _useR = Menu.Add("UseRinCombo", new CheckBox("UseRinCombo", false));
                }
        ...
        public static class Misc
        {
            ...
            private static readonly CheckBox _WforAlly;
            private static readonly CheckBox _WforMyself;
            private static readonly Slider _MinMana;
            private static readonly Slider _MinHP;
            private static readonly Slider _Allies;


            public static bool WforAlly
            {
                get { return _WforAlly.CurrentValue; }
            }
            public static bool WforMyself
            {
                get { return _WforMyself.CurrentValue; }
            }
        ...
        public static class Drawing
        {
            ...
            static Drawing()
            {
                ...
                _drawR = Menu.Add("drawR", new CheckBox("Draw R(Yellow)", false));
            }
